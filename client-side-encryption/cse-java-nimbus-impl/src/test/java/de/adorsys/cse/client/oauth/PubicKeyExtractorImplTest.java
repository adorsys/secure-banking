...
public class PubicKeyExtractorImplTest {
    ...
    public void generateTokenWithPubKey() throws Exception {
        ...
        // Output
        final String base64encodedJWK = java.util.Base64.getEncoder().withoutPadding().encodeToString(jwk.toJSONString().getBytes());
        final String base64encodedJWKApache = Base64.encodeBase64URLSafeString(jwk.toJSONString().getBytes());
